...
const fillPageWithStudentData = (data) => {
  ...
  document.querySelector("#studentBuildingNumber").value =
    data.flatNumber || "";
  ...
  document.querySelector("#studentGuardianName").value =
    data.guardianName || "";
  document.querySelector("#studentGuardianSurname").value =
    data.guardianSurname || "";
  document.querySelector("#studentGuardianPhoneNumber").value =
    data.guardianPhoneNumber || "";
  document.querySelector("#studentGuardianEmail").value =
    data.guardianEmail || "";
  document.querySelector("#studentGuardianCity").value =
    data.guardianCity || "";
  document.querySelector("#studentGuardianStreet").value =
    data.guardianStreet || "";
  document.querySelector("#studentGuardianBuildingNumber").value =
    data.guardianFlatNumber || "";
  document.querySelector("#studentGuardianPostcode").value =
  ...
  document.querySelector("#studentCompanyPhoneNumber").value =
    data.companyPhoneNumber || "";
  document.querySelector("#studentCompanyEmail").value =
    data.companyEmail || "";
  document.querySelector("#studentCompanyCity").value = data.companyCity || "";
  document.querySelector("#studentCompanyStreet").value =
    data.companyStreet || "";
  document.querySelector("#studentCompanyBuildingNumber").value =
    data.companyFlatNumber || "";
  document.querySelector("#studentCompanyPostcode").value =
...
confirmBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    setRedirectToast("Pomyślnie usunięto ucznia", "success");
