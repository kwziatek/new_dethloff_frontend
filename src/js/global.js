...
export const createNameSurnameDropdownListElements = (
  nameSurnameDataArray,
  classNameForLI,
  dropdown,
) => {
  nameSurnameDataArray.forEach((personData) => {
    //data paragraph
    const dataParagraph = document.createElement("p");
    dataParagraph.innerHTML = personData.name + " " + personData.surname;
    dataParagraph.dataset.personId = personData.id;
    //list element
    const listElement = document.createElement("li");
    listElement.classList.add(classNameForLI);
    listElement.style.display = "none";
    listElement.appendChild(dataParagraph);
    //append to dropdown
